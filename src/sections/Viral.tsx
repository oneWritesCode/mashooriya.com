...
const Viral = ({ id }: ViralProps) => {
  ...
  const cardData = [
    ...
    {
      songName: "kehne laga",
      artistName: "Rushil Aswal",
      image: "/SongImage/kehne-laga.png",
      bgColor: "var(--Green)",
      rotation: -4,
    },
    {
      songName: "Khamma Ghani",
      artistName: "THE U.D, Aadduz",
      image: "/SongImage/khamma.png",
      bgColor: "var(--Yellow)",
      rotation: 6,
    },
    {
      songName: "chai party",
      artistName: "SARTHAK BIJALWAN",
      image: "/SongImage/chai-party.png",
      bgColor: "var(--Green)",
      rotation: -6,
    },
  ];
