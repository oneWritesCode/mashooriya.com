        ...
        <form className="w-full flex flex-col gap-10 md:gap-16">
          ...
          <div className="flex flex-col gap-12 md:gap-20">
            ...
            <div className="relative border-[4px] sm:border-[6px] border-Dark p-4 sm:p-5">
              ...
              <div className="absolute left-4 right-4 bottom-3 sm:bottom-4 h-[4px] sm:h-[6px] bg-Dark" />
            </div>
            ...
            {/* MESSAGE */}
            <div className="relative border-[4px] sm:border-[6px] border-Dark p-4 sm:p-5 pb-6 bg-Yellow">
              <span className="absolute -top-8 sm:-top-12 left-3 bg-Dark text-Yellow px-3 sm:px-4 py-1 sm:py-2 font-bold text-lg sm:text-2xl md:text-4xl rotate-[-6deg]">
                MESSAGE
              </span>
